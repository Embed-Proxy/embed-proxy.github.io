...
<ul>
  ...
  <li>Clean centered input form when no URL is provided (Enter key works)</li>
...
<ol>
  ...
  <li>Keep the file named <code>404.html</code></li>
  <li>Settings → Pages → enable GitHub Pages from the main branch</li>
